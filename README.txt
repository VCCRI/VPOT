...
#                                                                                                                                                                                  
# VPOT is a Python tool written to allow prioritisation of variants in ANNOVAR annotated VCF files.                                                                                
# VPOT provides three functions for the purpose of speeding up variant discovery.                                                                                                  
#        option 1 - priority tool                                                                                                                                                  
#               2 - gene filter                                                                                                                                                    
#               3 - samples filtering                                                                                                                                              
#                                                                                                                                                                                  
#  Entry :                                                                                                                                                                         
...
###################################################################################################################################################################################
#
# Setting up PF population filter in parameter file (PF	Population_filter	Value)
#
# To provide population frequency threshold for selection of variants.
#
# FORMAT
#
# PF	<population frequency annotation name in VCF>	Value
#
# Example :
# PF	ExAC_ALL	0.01
#
...
#
###################################################################################################################################################################################
# Setting up PD predictors in parameter file (PD	Predictors	Type	Low	Value	Mid	Value	High	Value)
#
...
#
# Example :
# PD	CADD_phred	N	10	0	20	1	20	2
# where x < 10 = 0
#       10 < x < 20 = 1
#       x > 20 = 2
#
...
#
###################################################################################################################################################################################
# Setting up VT annotation in parameter file (VT	Variant_annotation	Exception_variant_types	Value)
#
...
# FORMAT
#
# VT	<annotation field name in VCF that holds the >	<the variant type>	Value
#
# Example :
#
...
#
###################################################################################################################################################################################
# Setting up GN gene symbol in parameter file (GN	Gene Symbol)
#
#
...
# FORMAT
#
# GN	<annotation field name in VCF that holds the gene name> 
#
# Example :
#
# GN	Gene Symbol
...
#                     -  PATIENT2	1  = unaffected (variant IS NOT in PATIENT2)                                                                                                   
